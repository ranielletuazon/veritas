...
import { findCategoryBySlug, productImgSrc } from "../data/products";
                                ...
                                return (
                                    <Reveal key={item.id} delay={i * 90}>
                                        <article className="group relative flex h-full flex-col overflow-hidden rounded-xl border border-slate-200 bg-white transition-colors duration-300 hover:border-indigo-200">
                                            {/* Unit image stage — only rendered for physical units */}
                                            {item.image && (
                                            ...
                                            <div className="relative flex flex-1 flex-col p-6">
                                                ...
                                                {/* Badge shown inline only when there's no image stage to host it */}
                                                {!item.image && item.badge && (
                                                    <span className="mb-3 w-fit rounded-full bg-indigo-50 px-2.5 py-1 font-mono text-[9px] font-semibold uppercase tracking-widest text-indigo-600">
                                                        {item.badge}
                                                    </span>
                                                )}
