...
export default function Careers() {
    return (
        <>
            <Seo
                title="Careers - Veritas Organisation"
                description="Open roles at Veritas Organisation — join a performance-driven sales team with real growth opportunities."
                path="/careers"
            />
            <Header />
                        ...
                        <div>
                            ...
                            <Reveal delay={160}>
                                <p className="mt-5 max-w-lg text-sm leading-relaxed text-slate-500 sm:text-base">
                                    We're always looking for driven people to
                                    join the team. Passionate about growth and
                                    ready to work in a high-energy environment?
                            ...
                            {CAREERS.map((job, i) => (
                                <Reveal key={job.id} delay={i * 100}>
                                    <a
                                        ...
                                        className="group relative flex h-full flex-col overflow-hidden rounded-xl border border-slate-200 bg-white p-6 transition-colors duration-300 hover:border-indigo-200 lg:p-7"
                                    >
